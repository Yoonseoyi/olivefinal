...
let apiKey = "AIzaSyDrTeY6MZfM9H-hT6GJLTx1P3__jjUmp7Y";
const systemPrompt =
...
/* 이미지 영역이 눌렸을 떄 음성인식 실행되도록 
   startSpeechRecognition() 을 적절한 위치에 작성 */
...
async function generateResponse(question) {
    ...
    try {
        ...
        ai_response = responseText;
        state = 2;    
        /* 콘솔창에 출력되고 있는 responseText을 아래 speakText 함수에 넣어
           음성 답변으로 변경하도록 코드 추가 */
...
/* 주어진 text를 음성 파일로 변환하여 재생하는 함수 추가하기 */
